...
| M4 | Full fast PPU (modes 2–7, offset-per-tile, windows, color math, mosaic, hi-res) | PeterLemon PPU suite hashes | In progress — M4.1 planar modes 2/3/4 + 8bpp, M4.2 mosaic, M4.3 offset-per-tile, M4.4 windows (main-screen) done; Mode 7, color math, hi-res queued |
