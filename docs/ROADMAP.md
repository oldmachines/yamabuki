...
| M4 | Full fast PPU (modes 2–7, offset-per-tile, windows, color math, mosaic, hi-res) | PeterLemon PPU suite hashes | In progress — M4.1 planar modes 2/3/4 + 8bpp done; mosaic, offset-per-tile, windows, color math, Mode 7, hi-res queued |
