...
gameplay: on the 137k-frame Brinstar take the slowdown falls from 2,366
frames to 567 and the S-CPU's utilisation from 46% to 3%, with the same
game-state sequence as stock end to end. This image is NOT verified by
