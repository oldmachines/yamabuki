...
pub fn main(init: std.process.Init) !void {
    ...
    // shell only — the SA-1 boots and parks) must render and sound identical.
    {
        ...
        const sa1 = try core.sa1gen.convert(gpa, image, &empty, null, &.{}, &.{}, @splat(0), &refusal);
    ...
    var wg_sites: u32 = 0;
    {
        ...
        var refusal: ?core.sa1gen.Refusal = null;
        const wg_res = core.sa1gen.convertWholeGame(gpa, demo, usage, null, null, false, false, &.{}, false, &refusal) catch |e| {
            if (e == error.Refused) {
